...
public class Board2DTO implements Serializable {
	...
	public Board2DTO(int num, String title, String content, String writer, String writeDate, int readCnt, int repRoot,
	...
	public String toString() {
		return "Board2DTO [num=" + num + ", title=" + title + ", content=" + content + ", writer=" + writer
