...
public class Page3TO {
	private int perPage = 20;
	private int amount;
	private int curPage;
	private int totalPage;
	private List<Board3DTO> list;
	...
	public List<Board3DTO> getList() {
		return list;
	}

	public void setList(List<Board3DTO> list) {
		this.list = list;
	}
	...
	public String toString() {
		return "Page3TO [perPage=" + perPage + ", amount=" + amount + ", curPage=" + curPage + ", totalPage=" + totalPage
