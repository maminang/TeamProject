...
public class Board1DTO implements Serializable {
	/**
	 * 
	 */
	...
	public Board1DTO(int num, String title, String content, String writer, String writeDate, int readCnt, int repRoot,
	...
	public String toString() {
		return "Board1DTO [num=" + num + ", title=" + title + ", content=" + content + ", writer=" + writer
