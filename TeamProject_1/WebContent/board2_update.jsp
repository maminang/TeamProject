...
<body>
	...
	<br>
	<Br>
	<form action="update.final2">
		<input type="hidden" value="${dto.num}" name="num">
			<table class="type04" >
				<tr>
					<td >제목</td>
					<td><input style="width:300px" name="title" placeholder="제목" required value="${dto.title}"></td>
				</tr>
			<tr>
				<td>작성자</td>
				<td><input value="${dto.writer}" readonly="readonly" style="width:300px" name="title"></td>
			</tr>
			<tr>
				<td>내용</td>
	...
	<form action="read.final2?curPage=${curPage}">
